...
function Home({ addCompare }) {
    ...
    return (
        <div className="wrapper">
            <>
                <StyledModal title= {saralangan[lang]} visible={isModalVisible} onOk={handleOk}
                                ...
                                <div>
                                    ...
                                    <Row gutter={16}>
                                        <Col span={12}>
                                            ...
                                            <div>
                                                <Input value={data?.yili_from} addonAfter={yearInput[lang]}
                                        ...
                                        <Col span={12}>
                                            ...
                                            <div>
                                                <Input value={data?.yili_to} addonAfter={yearInput[lang]}
                                                    onChange={value => setData({
                                                        ...data,
                                    ...
                                    <Row gutter={16}>
                                        <Col span={12}>
                                            <div>
                                                ...
                                                <Input value={data?.narxi_from} addonAfter={sumInput[lang]}
                                                    onChange={value => setData({
                                                        ...data,
                                        ...
                                        <Col span={12}>
                                            <div>
                                                ...
                                                <Input value={data?.narxi_to} addonAfter={sumInput[lang]}
                                                    onChange={value => setData({
                                                        ...data,
